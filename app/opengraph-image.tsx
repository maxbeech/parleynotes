  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ marginTop: 40, fontSize: 64, fontWeight: 800, color: "#1c1917", lineHeight: 1.1, maxWidth: 900 }}>
          Open-source AI meeting notes that stay <span style={{ color: "#059669" }}>private</span>.
        </div>
